        ...
        return (
            <Fragment>
                ...
                <BlockList header={<ListHeader header_text="блог" link_text="Все статьи">
                    <svg className="d-none d-lg-inline" width="306" height="193" viewBox="0 0 306 193" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.5" d="M12.5007 174C19.5008 51 112.587 52.5699 138.341 54.4457C164.094 56.3215 190.977 85.3932 182.543 98.4543C174.109 111.516 154.428 107.013 143.543 88.2943C129.992 64.991 133.492 55.8131 142.26 35.5633C151.029 15.3136 199.539 -6.23422 231.331 3.2035C263.124 12.6412 288.501 29.5005 305.501 59.5" stroke="#767676" stroke-linejoin="round" stroke-dasharray="6 4"/>
